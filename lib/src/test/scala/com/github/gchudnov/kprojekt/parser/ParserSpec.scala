  ...
  "Parser" when {
    "parse fan-out topology description" should {
      "return the parsed structure" in {
        val errOrInput = FileOps.stringFromResource("topologies/fan-out.log")
    ...
    "parse global-store topology description" should {
      "return the valid structure" in {
        val errOrInput = FileOps.stringFromResource("topologies/global-store.log")
        errOrInput.isRight shouldBe true
    ...
    "parse an invalid input" should {
      "return an error" in {
        val errOrInput = FileOps.stringFromResource("topologies/invalid-structure.log")
        errOrInput.isRight shouldBe true
