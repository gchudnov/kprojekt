  ...
  "Parser" when {
    "parse fan-out topology description" should {
      "return the parsed structure" in {
        val input = FileOps.stringFromResource("topologies/fan-out.log")
    ...
    "parse global-store topology description" should {
      "return the valid structure" in {
        val input = FileOps.stringFromResource("topologies/global-store.log")
        val errOrTopology = Parser.run(input)
    ...
    "parse an invalid input" should {
      "return an error" in {
        val input = FileOps.stringFromResource("topologies/invalid-structure.log")
        val errOrTopology = Parser.run(input)
